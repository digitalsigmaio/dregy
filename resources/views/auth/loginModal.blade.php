        ...
        <div class="modal-content form-elegant">
            ...
            <div class="modal-body mx-4">
                ...
                <div class="row my-3 d-flex justify-content-center">
                    <!--Facebook-->
                    <a class="btn btn-white btn-rounded mr-md-3 z-depth-1a" href="/auth/facebook" target="_blank" @click="socialLogin(facebook)"><i class="fab fa-facebook-f text-center blue-text"></i></a>
                </div>
            </div>
            <!--Footer-->
