...
<div id="jobList">
    ...
    <section  class="mt-5">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(job, index) in jobs" :key="job.id">
                                ...
                                <td>
                                    ...
                                    <a class="red-text pr-2 delete" data-toggle="tooltip" data-placement="top" title="Remove" @click.prevent="deleteJob(delete_link)"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
            ...
            <div  class="row p-5 rgba-grey-light z-depth-1" v-else>
...
<script>
    export default{
        ...
        methods: {
            show(id) {
                this.job = this.jobs.filter(function (job) { 
                    return job.id === id 
                    }).shift();
