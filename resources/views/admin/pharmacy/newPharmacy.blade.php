            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form class="form-horizontal form-label-left" action="{{ route('storePharmacy') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Pharmacy Clinic Arabic Name</label>
                                <div  class="col-md-9 col-sm-9 col-xs-12">
                                    <input style="text-align:right" type="text" class="form-control" name="ar_name" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Pharmacy Clinic English Name</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
