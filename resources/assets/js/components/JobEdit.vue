                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                v-for="phone in phonunmbers"
                                    <div  class="phone-input ml-2 mb-2">
                                        <div class="md-form input-group pl-0 mb-1">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span>
                                            </div>
                                            <input type="tel" class="form-control py-0" maxlength="15" 'namephoneid' v-model="phone_id" placeholder="Phone" :value="phone.number" aria-describedby="basic-addon1" required>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="waves-input-wrapper waves-effect waves-light float-right mt-2">
                                    <input type="submit" value="Update" @click.prevent="post()" class="btn btn-primary">
                                </div>
                            </div>
                        </div>
...
<script>
    export default{
        props: ['regions', 'categories', 'experienceLevels', 'educationLevels', 'employmentTypes','title', 
                'description', 'salary', 'categoryId', 'jobTypeId', 'experienceLevelId', 
                'educationLevelId', 'employmentTypeId', 'regionId', 'cityId', 'address', 'phonenumber', 'success'],
        data() {
            return {
                cities: null,
                errors: [],
        ...
        methods: {
            ...
            post() {
                axios
                .post('/job-ads/' + this.jobAd.id + '/edit',{
                    title : this.title,
                    salary : this.salary,
                    description : this.description,
