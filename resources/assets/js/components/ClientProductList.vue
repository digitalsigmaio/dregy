<template>
    <div id="productList">
        ...
        <section  class="mt-5">
                <div class="col-md-8 card" v-if="products.length">
                            ...
                            <tbody>
                                <tr v-for="(product, index) in products" :key=index>
                                    ...
                                    <td>
                                        ...
                                        <a class="red-text pr-2 delete" data-toggle="tooltip" data-placement="top" @click.prevent="deleteProduct(product.id)" title="Remove"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div v-else class="row p-5 rgba-grey-light z-depth-1">
        ...
        methods: {
            ...
            deleteProduct(id)
            {
                if(confirm('Are you sure?')){
                    window.location.href = '/product-ads/'+id+'/delete';
                }
            }
        },
        mounted() {
