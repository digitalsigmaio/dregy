...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    return function (t, e, i, n) {
        ...
        function r(t, i, n, o) {
            ...
            var f = 4, p = .001, m = 1e-7, g = 10, v = 11, y = 1 / (v - 1), b = "Float32Array" in e;
        ...
        function l(t) {
            if (t) {
                ...
                for (var o = 0; i > o; o++)if (v.State.calls[o]) {
                    var r = v.State.calls[o], s = r[0], d = r[2], h = r[3], p = !!h, m = null;
                    ...
                    for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                        ...
                        if (a(C)) {
                            ...
                            for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k)if ("element" !== T) {
                                var M, I = k[T], P = f.isString(I.easing) ? v.Easings[I.easing] : I.easing;
                                ...
                                if (I.currentValue = M, "tween" === T) m = M; else {
                                    if (b.Hooks.registered[T]) {
                                        var D = b.Hooks.getRoot(T), _ = a(C).rootPropertyValueCache[D];
        ...
        function c(t, e) {
            ...
            for (var i = v.State.calls[t][0], o = v.State.calls[t][1], r = v.State.calls[t][2], s = v.State.calls[t][4],
                     l = !1, c = 0, d = i.length; d > c; c++) {
                var h = i[c].element;
                            ...
                            for (var O in a(r).tweensContainer && !0 === a(r).isAnimating && (D = a(r).tweensContainer), u.each(y, function (t, e) {
                                if (RegExp("^" + b.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (b.RegEx.isHex.test(o)) {
                                        for (var s = ["Red", "Green", "Blue"], l = b.Values.hexToRgb(o),
                                                 c = r ? b.Values.hexToRgb(r) : n, u = 0; u < s.length; u++) {
                                            var d = [l[u]];
                                ...
                                var R = h(y[O]), W = R[0], H = R[1], N = R[2];
                                O = b.Names.camelCase(O);
                                var z = b.Hooks.getRoot(O), V = !1;
                                if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                    ...
                                    if (N = (B = p(O, N))[0], Y = B[1], W = (B = p(O, W))[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return $ = e, ""
                                        }), j = B[1], N = parseFloat(N) || 0, W = parseFloat(W) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (W /= 100, j = "em") : /^scale/.test(O) ? (W /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (W = W / 100 * 255, j = "")), /[\/*]/.test($)) j = Y; else if (Y !== j && 0 !== N)if (0 === W) j = Y; else {
                                        o = o || m();
                                        var q = /margin|padding|left|right|width|text|word|letter/i.test(O) || /X$/.test(O) || "x" === O ? "x" : "y";
                                        switch (Y) {
                                            case"%":
                                                N *= "x" === q ? o.percentToPxWidth : o.percentToPxHeight;
                                                break;
                                            case"px":
                                                break;
                                            default:
                                        ...
                                        switch (j) {
                                            case"%":
                                                N *= 1 / ("x" === q ? o.percentToPxWidth : o.percentToPxHeight);
                                                break;
                                            case"px":
                                                break;
                                            default:
                        ...
                        default:
                            if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                                if (f.isString(y) && v.Redirects[y]) {
                                    var A = (O = u.extend({}, w)).duration, D = O.delay || 0;
        ...
        1: [function (t, e, i) {
            ...
            n._set("bar", {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: o.Rectangle, initialize: function () {
                        ...
                        var t, e, i = this.getIndexScale(), n = this.getStackCount(), o = this.index, a = [],
                            r = i.isHorizontal(), s = r ? i.left : i.top, l = s + (r ? i.width : i.height);
                        ...
                        var i, n, o, a, r, s, l = this.chart, c = this.getMeta(), u = this.getValueScale(),
                            d = l.data.datasets, h = u.getRightValue(d[t].data[e]), f = u.options.stacked, p = c.stack,
                            m = 0;
                        ...
                        var n, o, r, s, l, c = i.scale.options, u = this.getStackIndex(t), d = i.pixels, h = d[e],
                            f = d.length, p = i.start, m = i.end;
            ...
            n._set("doughnut", {
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    getMaxBorderWidth: function (t) {
                        for (var e, i, n = 0, o = this.index, a = t.length,
                                 r = 0; r < a; r++)e = t[r]._model ? t[r]._model.borderWidth : 0, n = (i = t[r]._chart ? t[r]._chart.config.data.datasets[o].hoverBorderWidth : 0) > (n = e > n ? e : n) ? i : n;
                        return n
                    }
                })
            }
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    update: function (t) {
                        var i, n, o, r = this, s = r.getMeta(), l = s.dataset, c = s.data || [], u = r.chart.options,
                            d = u.elements.line, h = r.getScaleForId(s.yAxisID), f = r.getDataset(), p = e(f, u);
                    ...
                    updateElement: function (t, e, i) {
                        var n, o, r = this, s = r.getMeta(), l = t.custom || {}, c = r.getDataset(), u = r.index,
                            d = c.data[e], h = r.getScaleForId(s.yAxisID), f = r.getScaleForId(s.xAxisID),
            ...
            n._set("polarArea", {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    ...
                    updateElement: function (t, e, i) {
                        for (var n = this, o = n.chart, r = n.getDataset(), s = o.options, l = s.animation, c = o.scale,
                                 u = o.data.labels, d = n.calculateCircumference(r.data[e]), h = c.xCenter,
                                 f = c.yCenter, p = 0, m = n.getMeta(),
                                 g = 0; g < e; ++g)isNaN(r.data[g]) || m.data[g].hidden || ++p;
                        var v = s.startAngle, y = t.hidden ? 0 : c.getDistanceFromCenterForValue(r.data[e]),
                            b = v + d * p, x = b + (t.hidden ? 0 : d),
            ...
            n._set("global", {
                ...
                t.Animation = o.extend({
                    ...
                    advance: function (t) {
                        for (var e, i, n = this.animations,
                                 o = 0; o < n.length;)i = (e = n[o]).chart, e.currentStep = (e.currentStep || 0) + t, e.currentStep = Math.min(e.currentStep, e.numSteps), a.callback(e.render, [i, e], i), a.callback(e.onAnimationProgress, [e], i), e.currentStep >= e.numSteps ? (a.callback(e.onAnimationComplete, [e], i), i.animating = !1, n.splice(o, 1)) : ++o
                    }
            ...
            "use strict";
            var n = t(25), o = t(45), a = t(28), r = t(48);
            e.exports = function (t) {
                var e = t.plugins;
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                    construct: function (e, i) {
                        ...
                        var s = r.acquireContext(e, i), l = s && s.canvas, c = l && l.height, u = l && l.width;
                        ...
                        var i = this, n = i.options, a = i.canvas, r = n.maintainAspectRatio && i.aspectRatio || null,
                        ...
                        n.scales && (r = r.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var r = n.options, s = o.valueOrDefault(r.type, n.dtype),
                        ...
                        return o.each(e.data.datasets, function (o, a) {
                            ...
                            if (r.type && r.type !== s && (e.destroyDatasetMeta(a), r = e.getDatasetMeta(a)), r.type = s, i.push(r.type), r.controller) r.controller.updateIndex(a); else {
                        ...
                        var i = this.getDatasetMeta(t), n = {meta: i, index: t};
                        ...
                        var a = i.duration, r = i.lazy;
                        if (!1 !== e.notify(n, "beforeRender")) {
                            var s = n.options.animation, l = function (t) {
                        ...
                        for (var e = 0,
                                 i = (this.data.datasets || []).length; e < i; ++e)this.isDatasetVisible(e) && this.getDatasetMeta(e).controller.transition(t);
                        ...
                        var n = this.getDatasetMeta(t), o = {meta: n, index: t, easingValue: i};
                        !1 !== e.notify(this, "beforeDatasetDraw", [o]) && (n.controller.draw(i), e.notify(this, "afterDatasetDraw", [o]))
                    }, _drawTooltip: function (t) {
                        var i = this.tooltip, n = {tooltip: i, easingValue: t};
                        ...
                        for (var t = 0, e = 0,
                                 i = this.data.datasets.length; e < i; ++e)this.isDatasetVisible(e) && t++;
                        return t
            ...
            e.exports = function (t) {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    update: n.noop,
                    transition: function (t) {
                        for (var e = this.getMeta(), i = e.data || [], n = i.length,
                                 o = 0; o < n; ++o)i[o].transition(t);
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        for (var n, o = ["fullWidth", "position", "weight"], a = o.length,
                                 r = 0; r < a; ++r)n = o[r], i.hasOwnProperty(n) && (e[n] = i[n])
                    }, update: function (t, o, a) {
                        if (t) {
                            var r = t.options.layout || {}, s = n.options.toPadding(r.padding), l = s.left, c = s.right,
                                u = s.top, d = s.bottom, h = e(t.boxes, "left"), f = e(t.boxes, "right"),
                                p = e(t.boxes, "top"), m = e(t.boxes, "bottom"), g = e(t.boxes, "chartArea");
                            i(h, !0), i(f, !1), i(p, !0), i(m, !1);
                            var v = o - l - c, y = a - u - d, b = y / 2, x = (o - v / 2) / (h.length + f.length),
                                w = (a - b) / (p.length + m.length), k = v, C = y, S = [];
            ...
            n._set("scale", {
                ...
                t.Scale = o.extend({
                    ...
                    calculateTickRotation: function () {
                        ...
                        if (o.length && t.options.display && t.isHorizontal())for (var c,
                                                                                       u = a.longestText(e, r.font, o, t.longestTextCache),
                                                                                       d = u,
                                                                                       h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > h && l < n.maxRotation;) {
                            var f = a.toRadians(l);
                    ...
                    fit: function () {
                        var t = this, n = t.minSize = {width: 0, height: 0}, o = s(t._ticks), l = t.options,
                            c = l.ticks, u = l.scaleLabel, d = l.gridLines, h = l.display, f = t.isHorizontal(),
                            p = i(c), m = l.gridLines.tickMarkLength;
                        ...
                        if (c.display && h) {
                            var v = a.longestText(t.ctx, p.font, o, t.longestTextCache), y = a.numberOfLabelLines(o),
                                b = .5 * p.size, x = t.options.ticks.padding;
                            if (f) {
                                ...
                                var S = e(t.ctx, o[0], p.font), T = e(t.ctx, o[o.length - 1], p.font);
                    ...
                    _autoSkip: function (t) {
                        var e, i, n, o, r = this, s = r.isHorizontal(), l = r.options.ticks.minor, c = t.length,
                            u = a.toRadians(r.labelRotation), d = Math.cos(u), h = r.longestLabelWidth * d, f = [];
                    ...
                    draw: function (t) {
                        ...
                        if (o.display) {
                            var s = e.ctx, c = n.global, u = o.ticks.minor, d = o.ticks.major || u, h = o.gridLines,
                                f = o.scaleLabel, p = 0 !== e.labelRotation, m = e.isHorizontal(),
                                ...
                                k = a.valueOrDefault(f.fontColor, c.defaultFontColor), C = i(f),
                                S = a.options.toPadding(f.padding), T = a.toRadians(e.labelRotation), M = [],
                            ...
                            if (a.each(g, function (i, n) {
                                    if (!a.isNullOrUndef(i.label)) {
                                        ...
                                        var F = "middle", R = "middle", W = u.padding;
                                        if (m) {
                                            var H = w + W;
                                    ...
                                    if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
                                        ...
                                        var e = t.label;
                                        if (a.isArray(e))for (var i = 0,
                                                                  n = 0; i < e.length; ++i)s.fillText("" + e[i], 0, n), n += 1.5 * y.size; else s.fillText(e, 0, 0);
                                        s.restore()
                                    }
                                }), f.display) {
                                var _, E, O = 0, L = r(f) / 2;
                                if (m) _ = e.left + (e.right - e.left) / 2, E = "bottom" === o.position ? e.bottom - L - S.bottom : e.top + L + S.top; else {
                            ...
                            if (h.drawBorder) {
                                ...
                                var R = e.left, W = e.right, H = e.top, N = e.bottom, z = a.aliasPixel(s.lineWidth);
            ...
            n._set("global", {
                ...
                t.Tooltip = o.extend({
                    initialize: function () {
                        ...
                        var i, n, o, s, l, c, u, d = this, h = d._options, f = d._model, p = d._model = r(h),
                            m = d._active, g = d._data, v = {xAlign: f.xAlign, yAlign: f.yAlign}, y = {x: f.x, y: f.y},
                        ...
                        if (m.length) {
                            ...
                            h.filter && (C = C.filter(function (t) {
                                ...
                                var n = t.x, o = t.y, a = t.caretSize, r = t.caretPadding, s = t.cornerRadius,
                                    l = i.xAlign, c = i.yAlign, u = a + r, d = s + r;
                        ...
                        var n, o, a, r, s, l, c = i.caretSize, u = i.cornerRadius, d = i.xAlign, h = i.yAlign, f = t.x,
                            p = t.y, m = e.width, g = e.height;
                        if ("center" === h) s = p + g / 2, "left" === d ? (o = (n = f) - c, a = n, r = s + c, l = s - c) : (o = (n = f + m) + c, a = n, r = s - c, l = s + c); else if ("left" === d ? (n = (o = f + u + c) - c, a = o + c) : "right" === d ? (n = (o = f + m - u - c) - c, a = o + c) : (n = (o = f + m / 2) - c, a = o + c), "top" === h) s = (r = p) - c, l = r; else {
                            s = (r = p + g) + c, l = r;
                            var v = a;
                            a = n, n = v
                        }
            ...
            n._set("global", {
                ...
                inLabelRange: function (t) {
                    ...
                    var i = this._view;
                    if (i) {
                        for (var n = a.getAngleFromPoint(i, {x: t, y: e}), o = n.angle, r = n.distance,
                                 s = i.startAngle, l = i.endAngle; l < s;)l += 2 * Math.PI;
                        for (; o > l;)o -= 2 * Math.PI;
                        for (; o < s;)o += 2 * Math.PI;
                ...
                draw: function () {
                    ...
                    if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, o = e > t ? 1 : -1, a = 1, r = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, o = 1, a = (n = l.base) > i ? 1 : -1, r = l.borderSkipped || "bottom"), c) {
                        var u = Math.min(Math.abs(t - e), Math.abs(i - n)), d = (c = c > u ? u : c) / 2,
                            h = t + ("left" !== r ? d * o : 0), f = e + ("right" !== r ? -d * o : 0),
                            p = i + ("top" !== r ? d * a : 0), m = n + ("bottom" !== r ? -d * a : 0);
                        ...
                        if (!(isNaN(i) || i <= 0)) {
                            switch (e) {
                                ...
                                case"rect":
                                    ...
                                    break;
                                case"rectRounded":
                                    var d = i / Math.SQRT2, h = n - d, f = o - d, p = Math.SQRT2 * i;
            ...
            function m(t, e, i) {
                var c, u, d, f, m = t[o] || (t[o] = {}), g = m.resizer = function (t) {
            ...
            n._set("global", {plugins: {filler: {propagate: !0}}}), e.exports = function () {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (t, n) {
                        var a, l, c, u, d = (t.data.datasets || []).length, h = n.propagate, f = [];
                        ...
                        var i = e.meta.$filler;
                        if (i) {
                            var o = t.ctx, r = i.el, s = r._view, u = r._children || [], d = i.mapper,
                                h = s.backgroundColor || n.global.defaultColor;
                            d && h && u.length && (a.canvas.clipArea(o, t.chartArea), function (t, e, i, n, o, a) {
                                var r, s, u, d, h, f, p, m = e.length, g = n.spanGaps, v = [], y = [], b = 0, x = 0;
            ...
            n._set("global", {
                ...
                var e = t.layoutService, i = a.noop;
                ...
                return t.Legend = o.extend({
                    initialize: function (t) {
                        ...
                        var t = this, e = t.options, i = e.labels, o = e.display, s = t.ctx, l = n.global,
                            c = a.valueOrDefault, u = c(i.fontSize, l.defaultFontSize),
                            d = c(i.fontStyle, l.defaultFontStyle), h = c(i.fontFamily, l.defaultFontFamily),
                            f = a.fontString(u, d, h), p = t.legendHitBoxes = [], m = t.minSize, g = t.isHorizontal();
                        ...
                        var t = this, e = t.options, i = e.labels, o = n.global, s = o.elements.line, l = t.width,
                            c = t.lineWidths;
                        if (e.display) {
                            var u, d = t.ctx, h = a.valueOrDefault, f = h(i.fontColor, o.defaultFontColor),
                                p = h(i.fontSize, o.defaultFontSize), m = h(i.fontStyle, o.defaultFontStyle),
                                g = h(i.fontFamily, o.defaultFontFamily), v = a.fontString(p, m, g);
                            d.textAlign = "left", d.textBaseline = "middle", d.lineWidth = .5, d.strokeStyle = f, d.fillStyle = f, d.font = v;
                            var y = r(i, p), b = t.legendHitBoxes, x = t.isHorizontal();
                            u = x ? {x: t.left + (l - c[0]) / 2, y: t.top + i.padding, line: 0} : {
                                x: t.left + i.padding,
                                y: t.top + i.padding,
                                line: 0
                            };
                            ...
                            a.each(t.legendItems, function (n, r) {
                                var f = d.measureText(n.text).width, m = y + p / 2 + f, g = u.x, v = u.y;
                                x ? g + m >= l && (v = u.y += w, u.line++, g = u.x = t.left + (l - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding, v = u.y = t.top + i.padding, u.line++), function (t, i, n) {
                                    if (!(isNaN(y) || y <= 0)) {
                                        ...
                                        if (d.setLineDash && d.setLineDash(h(n.lineDash, s.borderDash)), e.labels && e.labels.usePointStyle) {
                                            var l = p * Math.SQRT2 / 2, c = l / Math.SQRT2, u = t + c, f = i + c;
                        ...
                        var a = t.x, r = t.y;
                        if (a >= e.left && a <= e.right && r >= e.top && r <= e.bottom)for (var s = e.legendHitBoxes,
                                                                                                l = 0; l < s.length; ++l) {
                            var c = s[l];
                    ...
                    id: "legend", beforeInit: function (t) {
                        ...
                        var i = t.options.legend, o = t.legend;
            ...
            n._set("global", {
                ...
                return t.Title = o.extend({
                    ...
                    draw: function () {
                        ...
                        if (o.display) {
                            var s, l, c, u = i(o.fontSize, r.defaultFontSize), d = i(o.fontStyle, r.defaultFontStyle),
                                h = i(o.fontFamily, r.defaultFontFamily), f = a.fontString(u, d, h),
                                p = a.options.toLineHeight(o.lineHeight, u), m = p / 2 + o.padding, g = 0, v = t.top,
                            ...
                            var w = o.text;
                            if (a.isArray(w))for (var k = 0,
                                                      C = 0; C < w.length; ++C)e.fillText(w[C], 0, k, s), k += p; else e.fillText(w, 0, 0, s);
                            e.restore()
                        }
                    }
                }), {
                    id: "title", beforeInit: function (t) {
                        ...
                        var o = i.options.title, s = i.titleBlock;
            ...
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: a.formatters.linear}}, i = t.LinearScaleBase.extend({
                    determineDataLimits: function () {
                        ...
                        var e, i = this, n = i.start, o = +i.getRightValue(t), a = i.end - n;
            ...
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: o.formatters.logarithmic}}, i = t.Scale.extend({
                    determineDataLimits: function () {
                        var t = this, e = t.options, i = e.ticks, o = t.chart, a = o.data.datasets,
                            r = n.valueOrDefault, s = t.isHorizontal();
                        ...
                        var e, i, o, a = this, r = a.start, s = +a.getRightValue(t), l = a.options.ticks;
                        ...
                        var e, i, o = this, a = n.log10(o.end) - n.log10(o.start);
            ...
            e.exports = function (t) {
                ...
                function u(t, e, i, n) {
                    if (o.isArray(e))for (var a = i.y, r = 1.5 * n,
                                              s = 0; s < e.length; ++s)t.fillText(e[s], i.x, a), a += r; else t.fillText(e, i.x, i.y)
                }
                ...
                var f = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        if (i.display) {
                            var h = t.ctx, f = this.getIndexAngle(0), p = l(a.fontSize, e.defaultFontSize),
                            ...
                            o.each(t.ticks, function (i, s) {
                                ...
                                var i = t.ctx, n = o.valueOrDefault, a = t.options, l = a.angleLines, h = a.pointLabels;
                                i.lineWidth = l.lineWidth, i.strokeStyle = l.color;
                                var f = t.getDistanceFromCenterForValue(a.ticks.reverse ? t.min : t.max), p = s(t);
                                i.textBaseline = "top";
                                for (var m = r(t) - 1; m >= 0; m--) {
                                    ...
                                    if (h.display) {
                                        var v = t.getPointPosition(m, f + 5), y = n(h.fontColor, e.defaultFontColor);
                                        i.font = p.font, i.fillStyle = y;
                                        var b = t.getIndexAngle(m), x = o.toDegrees(b);
            ...
            function g(t, e, i, o) {
                var r, u = o.time, d = u.unit || function (t, e, i, n) {
                            ...
                            return c[u - 1]
                        }(u.minUnit, t, e, i), h = m(d), f = a.valueOrDefault(u.stepSize, u.unitStepSize),
                    p = "week" === d && u.isoWeekday, g = o.ticks.major.enabled, v = l[d], y = n(t), b = n(e), x = [];
            ...
            e.exports = function (t) {
                var e = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, e, i, o, l, c, h = this, f = h.chart, m = h.options.time, g = s, v = r, y = [], b = [],
                            x = [];
                        for (t = 0, i = f.data.labels.length; t < i; ++t)x.push(p(f.data.labels[t], h));
                        for (t = 0, i = (f.data.datasets || []).length; t < i; ++t)if (f.isDatasetVisible(t))if (l = f.data.datasets[t].data, a.isObject(l[0]))for (b[t] = [], e = 0, o = l.length; e < o; ++e)c = p(l[e], h), y.push(c), b[t][e] = c; else y.push.apply(y, x), b[t] = x.slice(0); else b[t] = [];
                        ...
                        var t, e, i, o = this, a = o.min, r = o.max, s = o.options, u = s.time, d = [], f = [];
                        ...
                        var o = this.options, r = t.valueOf(), s = o.time.displayFormats, l = s[this._unit],
                            ...
                            f = h.enabled && c && u && r === d, p = t.format(n || (f ? u : l)),
                            m = f ? h : o.ticks.minor, g = a.valueOrDefault(m.callback, m.userCallback);
                        return g ? g(p, e, i) : p
...
$(window).scroll(function () {
    ...
    var l = {
        duration: 750, delay: 200, show: function (t, e, i) {
            ...
            for (var i = (e = e || this).getElementsByClassName("waves-rippling"), n = 0,
                     o = i.length; n < o; n++)u(t, e, i[n])
        }
    }, c = {
        input: function (t) {
            var e = t.parentNode;
    ...
    return t.init = function (t) {
        ...
        for (var r = 0,
                 s = t.length; r < s; r++)o = (n = t[r]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(o) && (c[o](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
    ...
    t(document).ready(function () {
        ...
        if (t(e).each(function (e, n) {
                var o = t(n), a = o.siblings("label, i");
                ...
                var i = t(e.target), o = !i.val(), a = !e.target.validity.badInput,
    ...
    t(document).ready(function () {
        t(document).on("click.card", ".card", function (e) {
            ...
            if (i.find(".card-reveal").length) {
                var n = t(e.target), o = n.is(".card-reveal .card-title"), a = n.is(".card-reveal .card-title i"),
                    r = n.is(".card .activator"), s = n.is(".card .activator i");
                o || a ? i.find(".card-reveal").velocity({translateY: 0}, {
                    duration: 225,
                    queue: !1,
                ...
                }) : (r || s) && i.find(".card-reveal").css({display: "block"}).velocity("stop", !1).velocity({translateY: "-100%"}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeInOutQuad"
                    })
        ...
        return function () {
            ...
            function u(i) {
                ...
                if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !function (t, e) {
                    ...
                    o++, e = s(a, !0);
                    var l = null, u = t("<div/>"), f = t("<div/>"), p = t("<div/>"), m = t("<div/>"),
        ...
        this.each(function () {
            ...
            function l(e) {
                ...
                var i = window.innerHeight, l = n.innerHeight(), c = n.offset().left,
                    u = n.offset().top - t(window).scrollTop(), d = o.alignment, h = 0, f = 0, p = 0;
                !0 === o.belowOrigin && (p = l);
                var m = 0, g = n.parent();
                ...
                if ("left" === d) h = o.gutter, f = n.position().left + h; else if ("right" === d) {
...
dropdownSelectors.on({
    ...
    var m = p(function (t, e, i) {
        ...
        return t
    }, "extend", "Use `assign`."), g = p(function (t, e) {
        return m(t, e, !0)
    }, "merge", "Use `assign`.");
    ...
    var E = "ontouchstart" in t, O = A(t, "PointerEvent") !== n,
        L = E && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent), F = 25, R = 1, W = 2, H = 4, N = 8,
        z = 1, V = 2, B = 4, j = 8, Y = 16, $ = V | B, q = j | Y, X = $ | q, U = ["x", "y"], Q = ["clientX", "clientY"];
    ...
    function G(t, e, i) {
        var o = i.pointers.length, a = i.changedPointers.length, r = e & R && o - a == 0, s = e & (H | N) && o - a == 0;
    ...
    var ot = {mousedown: R, mousemove: W, mouseup: H}, at = "mousedown", rt = "mousemove mouseup";
    ...
    var ft = {touchstart: R, touchmove: W, touchend: H, touchcancel: N}, pt = "touchstart",
            ...
            if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                if (n) (function (t, e) {
                    t & R ? (this.primaryTouch = e.changedPointers[0].identifier, Ct.call(this, e)) : t & (H | N) && Ct.call(this, e)
                        ...
                        for (var e = t.srcEvent.clientX, i = t.srcEvent.clientY,
    ...
    var St = A(r.style, "touchAction"), Tt = St !== n, Mt = "auto", It = "manipulation", Pt = "none", At = "pan-x",
        Dt = "pan-y", _t = function () {
            if (!Tt)return !1;
    ...
    Et.prototype = {
        set: function (t) {
            ...
            if (this.manager.session.prevented) e.preventDefault(); else {
                var n = this.actions, o = S(n, Pt) && !_t[Pt], a = S(n, Dt) && !_t[Dt], r = S(n, At) && !_t[At];
                if (o) {
                    var s = 1 === t.pointers.length, l = t.distance < 2, c = t.deltaTime < 250;
                    if (s && l && c)return
                }
                if (!r || !a)return o || a && i & $ || r && i & q ? this.preventSrc(e) : void 0
            }
        }, preventSrc: function (t) {
            this.manager.session.prevented = !0, t.preventDefault()
        }
    };
    var Ot = 1, Lt = 2, Ft = 4, Rt = 8, Wt = Rt, Ht = 16;
    ...
    Nt.prototype = {
        ...
        defaults: {pointers: 1}, attrTest: function (t) {
            ...
            var e = this.state, i = t.eventType, n = e & (Lt | Ft), o = this.attrTest(t);
        ...
        defaults: {event: "pan", threshold: 10, pointers: 1, direction: X}, getTouchAction: function () {
            ...
            return t & $ && e.push(Dt), t & q && e.push(At), e
        ...
        defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
            ...
            if (this._input = t, !n || !i || t.eventType & (H | N) && !o) this.reset(); else if (t.eventType & R) this.reset(), this._timer = d(function () {
                this.state = Wt, this.tryEmit()
            }, e.time, this); else if (t.eventType & H)return Wt;
            return 32
        }, reset: function () {
        ...
        defaults: {event: "swipe", threshold: 10, velocity: .3, direction: $ | q, pointers: 1},
        getTouchAction: function () {
            return Yt.prototype.getTouchAction.call(this)
        },
        attrTest: function (t) {
            var e, i = this.options.direction;
            return i & ($ | q) ? e = t.overallVelocity : i & $ ? e = t.overallVelocityX : i & q && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & H
        },
        emit: function (t) {
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[Xt, {enable: !1}], [$t, {enable: !1}, ["rotate"]], [Ut, {direction: $}], [Yt, {direction: $}, ["swipe"]], [Qt], [Qt, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [qt]],
        cssProps: {
...
!function (t) {
    var e = 240, i = 1440, n = 2, o = .3, a = -.5, r = -.3, s = .5, l = 10, c = function () {
        function c(u, d) {
            var h = this;
            _classCallCheck(this, c);
            var f = !1, p = {MENU_WIDTH: e, edge: "left", closeOnClick: !1};
            ...
            t("body").append(v), "left" === d.edge ? (this.menu_id.css("transform", "translateX(-100%)"), v.css({left: 0})) : (this.menu_id.addClass("right-aligned").css("transform", "translateX(100%)"), v.css({right: 0})), this.menu_id.hasClass("fixed") && (window.innerWidth > i && this.menu_id.css("transform", "translateX(0)"), t(window).resize(function () {
                ...
                if (e.preventDefault(), !0 === f) f = !1, h.removeMenu(); else {
                    var i = t("body"), n = t('<div id="sidenav-overlay"></div>');
                    i.append(n), "left" === h.options.edge ? h.menu_id.velocity({translateX: [0, -1 * d.MENU_WIDTH]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                ...
                h.removeMenu()
            }), v.hammer({prevent_default: !1}).bind("pan", function (e) {
                if ("touch" === e.gesture.pointerType) {
                    var i = e.gesture.center.x, o = t("body"), a = o.innerWidth();
                    ...
                    if ("left" === d.edge && (i > d.MENU_WIDTH ? i = d.MENU_WIDTH : i < 0 && (i = 0)), "left" === d.edge) i < d.MENU_WIDTH / n ? f = !1 : i >= d.MENU_WIDTH / n && (f = !0), h.menu_id.css("transform", "translateX(" + (i - d.MENU_WIDTH) + "px)"); else {
                    ...
                    var l = void 0;
                    "left" === d.edge ? (l = i / d.MENU_WIDTH, t("#sidenav-overlay").velocity({opacity: l}, {
                        duration: 10,
                        queue: !1,
                        easing: "easeOutQuad"
                    })) : (l = Math.abs((i - window.innerWidth) / d.MENU_WIDTH), t("#sidenav-overlay").velocity({opacity: l}, {
                        duration: 10,
                        queue: !1,
                        easing: "easeOutQuad"
                    }))
                ...
                if ("touch" === e.gesture.pointerType) {
                    var i = e.gesture.velocityX, c = e.gesture.center.x, u = c - d.MENU_WIDTH, p = c - d.MENU_WIDTH / n;
                    u > 0 && (u = 0), p < 0 && (p = 0), "left" === d.edge ? f && i <= o || i < a ? (0 !== u && h.menu_id.velocity({translateX: [0, u]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), v.css({width: "10px", right: "", left: 0})) : (!f || i > o) && (t("body").css({
                            overflow: "",
                            width: ""
                            ...
                            right: "",
                            left: 0
                        })) : f && i >= r || i > s ? (h.menu_id.velocity({translateX: [0, p]}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), t("#sidenav-overlay").velocity({opacity: 1}, {
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), v.css({width: "50%", right: "", left: 0})) : (!f || i < r) && (t("body").css({
                            overflow: "",
                            width: ""
    ...
    t(document).on("change", '.file-field input[type="file"]', function (e) {
        for (var i = t(e.target), n = i.closest(".file-field").find("input.file-path"), o = i[0].files, a = [],
                 r = 0; r < o.length; r++) {
            var s = o[r].name;
            a.push(s)
        }
    ...
    t.fn.material_select = function (e) {
        ...
        t(this).each(function () {
            ...
            if (!n.hasClass("browser-default")) {
                var o = Boolean(n.attr("multiple")), a = n.data("select-id");
                if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
                    var r,
                        s = (r = (new Date).getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (t) {
                    ...
                    var c, u,
                        d = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
                        h = n.children("option, optgroup"), f = [], p = !1,
                        m = n.find("option:selected").html() || n.find("option:first").html() || "", g = function () {
                            var e = t(this).closest("ul"), i = t(this).val();
                    ...
                    var y = function (e, i, n) {
                        var o = i.is(":disabled") ? "disabled " : "",
                            a = "optgroup-option" === n ? "optgroup-option " : "", r = i.data("icon"),
                            s = i.attr("class");
                        if (r) {
                            var l = "";
                    ...
                    h.length && h.each(function () {
                        if (t(this).is("option")) o ? y(0, t(this), "multiple") : y(0, t(this)); else if (t(this).is("optgroup")) {
                    ...
                    n.before(C), C.before(w), C.after(d), n.is(":disabled") || C.dropdown({
                        ...
                        focus: function () {
                            if (t("ul.select-dropdown").not(d[0]).is(":visible") && t("input.select-dropdown").trigger("close"), !d.is(":visible")) {
                                ...
                                var e = t(this).val(), i = d.find("li").filter(function () {
                        ...
                        if (9 != e.which)if (40 != e.which || d.is(":visible")) {
                            if (13 != e.which || d.is(":visible")) {
                                ...
                                if (i && -1 === [9, 13, 27, 38, 40].indexOf(e.which)) {
                                    T.push(i);
                                    var n = T.join(""), a = d.find("li").filter(function () {
    ...
    function a(e, l, u, d) {
        if (!e)return a;
        var h = !1, f = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))},
            p = u ? t.extend(!0, {}, u.defaults, d) : d || {}, m = t.extend({}, a.klasses(), p.klass), g = t(e),
            v = function () {
                return this.start()
            }, y = v.prototype = {
    ...
    o.prototype.set = function (t, e, i) {
        ...
        var a, r, s, l, c = this, u = i, d = o && o.interval ? o.interval : 1, h = -1 === c.item.enable, f = c.item.min,
            p = c.item.max, m = h && c.item.disable.filter(function (t) {
                    if (e.isArray(t)) {
        ...
        var e, i, o = this, a = o.settings, r = o.item, s = r.now, l = r.select, c = r.highlight, u = r.view,
            ...
            p = (e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), i = a.weekdaysFull.slice(0), a.firstDay && (e.push(e.shift()), i.push(i.shift())), n.node("thead", n.node("tr", n.group({
                ...
                if (i) {
                    var r = h.year, s = f.year, l = e - i, c = e + i;
    ...
    function S(t, e) {
        var i, o, r = n(C), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            f = r.find(".clockpicker-hours"), S = r.find(".clockpicker-minutes"),
            M = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), P = I ? t : t.find("input"),
            A = (P.prop("type"), n("label[for=" + P.attr("id") + "]")), D = this;
        ...
        }), O.html(0 === E ? 12 : E), f.append(O), O.on(u, N); else for (E = 0; E < 24; E += e.hourstep) {
        ...
        function N(t, i) {
            var n = l.offset(), o = /^touch/.test(t.type), r = n.left + v, c = n.top + v,
                u = (o ? t.originalEvent.touches[0] : t).pageX - r, f = (o ? t.originalEvent.touches[0] : t).pageY - c,
                p = Math.sqrt(u * u + f * f), m = !1;
            if (!i || !(p < y - x || p > y + x)) {
                t.preventDefault();
        ...
        if (l.on(u, function (t) {
            ...
            var z = r.find(".clockpicker-canvas"), V = p("svg");
            ...
            var q = p("circle");
            q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), B.appendChild(Y), B.appendChild($), B.appendChild(q), B.appendChild(j), V.appendChild(B), z.append(V), this.hand = Y, this.bg = $, this.fg = q, this.bearing = j, this.g = B, this.canvas = z
        }
        T(this.options.init)
    }
    ...
    return function (t, e, i, n) {
        var o = {
            features: null, bind: function (t, e, i, n) {
                ...
                for (var l, c, u = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"],
                         h = 0; 4 > h; h++) {
                    e = d[h];
                ...
                if (!i.raf) {
                    var p = 0;
                    i.raf = function (t) {
                        var e = (new Date).getTime(), i = Math.max(0, 16 - (e - p)), n = window.setTimeout(function () {
                            t(e + i)
                        }, i);
                        return p = e + i, n
                    }, i.caf = function (t) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, F, R, W, H, N, z, V, B,
            j, Y, $, q, X, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {x: 0, y: 0}, ct = {x: 0, y: 0},
            ut = {x: 0, y: 0}, dt = {}, ht = 0, ft = {}, pt = {x: 0, y: 0}, mt = 0, gt = !0, vt = [], yt = {}, bt = !1,
            xt = function (t, e) {
                ...
                if (!r.loop && e) {
                    var i = u + (pt.x * ht - t) / pt.x, n = Math.round(t - ce.x);
            ...
            }, Yt = {}, $t = 0, qt = function (t) {
                Yt[t] && (Yt[t].raf && E(Yt[t].raf), $t--, delete Yt[t])
            }, Xt = function (t) {
                Yt[t] && qt(t), Yt[t] || ($t++, Yt[t] = {})
            }, Ut = function () {
                for (var t in Yt)Yt.hasOwnProperty(t) && qt(t)
            }, Qt = function (t, e, i, n, o, a, r) {
                var s, l = Tt();
                Xt(t);
                var c = function () {
                    if (Yt[t]) {
                        if ((s = Tt() - l) >= n)return qt(t), a(i), void(r && r());
                ...
                shout: St, listen: Ct, viewportSize: dt, options: r, isMainScrollAnimating: function () {
                    ...
                    if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), pt.x = dt.x + Math.round(dt.x * r.spacing), pt.y = dt.y, _t(pt.x * ht), St("beforeResize"), void 0 !== h) {
                        for (var n, s, l,
                                 c = 0; 3 > c; c++)n = k[c], Dt((c + h) * pt.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ne(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && ($e(s, dt), Qe(s), At(s));
                        w = !1
                    }
            ...
            }, Gt = {}, Kt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {x: 0, y: 0},
            le = 0, ce = {x: 0, y: 0}, ue = {x: 0, y: 0}, de = {x: 0, y: 0}, he = function (t, e) {
                ...
                return i = l > J.min[t] || l < J.max[t] ? r.panEndFriction : 1, l = ut[t] + e[t] * i, !r.allowPanToNext && g !== a.currItem.initialZoomLevel || (tt ? "h" !== it || "x" !== t || q || (c ? (l > J.min[t] && (i = r.panEndFriction, J.min[t], n = J.min[t] - ct[t]), (0 >= n || 0 > d) && ze() > 1 ? (s = u, 0 > d && u > ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[t] && (i = r.panEndFriction, J.max[t], n = ct[t] - J.max[t]), (0 >= n || d > 0) && ze() > 1 ? (s = u, d > 0 && u < ne.x && (s = ne.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== t) ? void(et || Q || g > a.currItem.fitRatio && (ut[t] += e[t] * i)) : (void 0 !== s && (_t(s, !0), Q = s !== ne.x), J.min.x !== J.max.x && (void 0 !== o ? ut.x = o : Q || (ut.x += e.x * i)), void 0 !== s)
            }, Me = function (t) {
                if (!("mousedown" === t.type && t.button > 0)) {
                    ...
                    if (!j || "mousedown" !== t.type) {
                        ...
                        Z = null, Ut(), Y && 1 !== n || (Y = nt = !0, o.bind(window, f, a), V = rt = ot = B = Q = X = $ = q = !1, it = null, St("firstTouchStart", i), Ot(ct, ut), lt.x = lt.y = 0, Ot(te, i[0]), Ot(ee, te), ne.x = pt.x * ht, oe = [{
                            x: te.x,
                            y: te.y
                        }], N = H = Tt(), Wt(g, !0), fe(), pe()), !G && n > 1 && !et && !Q && (v = g, q = !1, G = $ = !0, lt.y = lt.x = 0, Ot(ct, ut), Ot(Gt, i[0]), Ot(Kt, i[1]), be(Gt, Kt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, K = he(Gt, Kt))
                    }
                }
            }, Ie = function (t) {
                ...
                if (Y) {
                    var n = Se(t);
                    if (it || X || G) Z = n; else if (ce.x !== pt.x * ht) it = "h"; else {
                ...
                if (Z) {
                    ...
                    if (0 !== t)if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
                        ...
                        Ot(Kt, Z[1]), q || (q = !0, St("zoomGestureStarted"));
                        var e = he(Gt, Kt), i = Oe(e);
                        ...
                        })(Tt(), Gt.x, Gt.y), X = !0, J = a.currItem.bounds, Te("x", Jt) || (Te("y", Jt), Lt(ut), Pt())
                    }
                }
            }, Ae = function (t) {
                if (W.isOldAndroid) {
                ...
                var c = -1;
                if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, X || q || et || B)if (Ut(), z || (z = De()), z.calculateSwipeSpeed("x"), B)if (xe() < r.verticalDragRange) a.close(); else {
                    var u = ut.y, d = at;
                ...
                var d, h = pt.x * ht, f = Math.abs(h - ce.x);
        ...
        var Fe, Re, We, He, Ne, ze, Ve = function (e, i, n, s) {
            ...
            var d = n ? r.hideAnimationDuration : r.showAnimationDuration, h = function () {
                qt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Mt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), He = !1
            };
            ...
            !function () {
                ...
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pt()), Xt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    if (St("initialZoom" + (n ? "Out" : "In")), n) {
                        var a = l.w / e.w, r = {x: ut.x, y: ut.y}, c = g, u = at, f = function (e) {
            ...
            if (je.length) {
                for (var t,
                         e = 0; e < je.length; e++)(t = je[e]).holder.index === t.index && qe(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                je = []
            }
        };
        xt("Controller", {
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    o.extend(r, Ye, !0), a.items = Re = i, Ne = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
                        ...
                        for (var t,
                                 e = 0; e < Re.length; e++)(t = Re[e]).container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                        je = null
                    })
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), $e(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), qe(0, l, c, n)); else {
                            ...
                            l.loading || Xe(l), a.allowProgressiveImg() && (!We && W.transform ? je.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: e,
        ...
        var Ge, Ke, Je = {}, ti = function (t, e, i) {
        ...
        xt("Tap", {
            ...
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    if (t.stopPropagation(), Ke.x = 0, "deltaX" in t) 1 === t.deltaMode ? (Ke.x = 18 * t.deltaX, Ke.y = 18 * t.deltaY) : (Ke.x = t.deltaX, Ke.y = t.deltaY); else if ("wheelDelta" in t) t.wheelDeltaX && (Ke.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? Ke.y = -.16 * t.wheelDeltaY : Ke.y = -.16 * t.wheelDelta; else {
                        if (!("detail" in t))return;
                        Ke.y = t.detail
                    }
                    Wt(g, !0);
                    var e = ut.x - Ke.x, i = ut.y - Ke.y;
        ...
        var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, fi = {history: !0, galleryUID: 1}, pi = function () {
            ...
            if (ni && clearTimeout(ni), $t || Y) ni = setTimeout(vi, 500); else {
    ...
    "use strict";
    return function (t, e) {
        var i, n, o, a, r, s, l, c, u, d, h, f, p, m, g, v, y, b, x = this, w = !1, k = !0, C = !0, S = {
            ...
            for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "",
                     a = 0; a < N.length; a++)(i = N[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
            if (n) {
            ...
            for (var t, e, i, n, o = "",
                     a = 0; a < g.shareButtons.length; a++)t = g.shareButtons[a], e = g.getImageURLForShare(t), i = g.getPageURLForShare(t), n = g.getTextForShare(t), o += '<a href="' + t.url.replace("{{url}}", encodeURIComponent(i)).replace("{{image_url}}", encodeURIComponent(e)).replace("{{raw_image_url}}", e).replace("{{text}}", encodeURIComponent(n)) + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", g.parseShareButtonOut && (o = g.parseShareButtonOut(t, o));
...
var initPhotoSwipeFromDOM = function (t) {
    for (var e = function (t) {
            ...
            if (e) {
                for (var n, o = e.parentNode, a = e.parentNode.childNodes, r = a.length, s = 0,
                         l = 0; l < r; l++)if (1 === a[l].nodeType) {
                    if (a[l] === e) {
                        n = s;
                        break
                    }
            ...
            if (a = function (t) {
                    for (var e, i, n, o, a = t.childNodes, r = a.length, s = [],
                             l = 0; l < r; l++)1 === (e = a[l]).nodeType && (n = (i = e.children[0]).getAttribute("data-size").split("x"), o = {
        ...
        }, n = document.querySelectorAll(t), o = 0,
             a = n.length; o < a; o++)n[o].setAttribute("data-pswp-uid", o + 1), n[o].onclick = e;
    var r = function () {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
    t.fn.sticky = function (e) {
        ...
        return this.each(function () {
            ...
            function f() {
                var r = h.scrollTop(), f = d, p = e.parent().width();
        ...
        return this.$el = t(this), this.$document = t(document), this.SELS = {
            ...
            o.$document.on("click", e.CHIPS, function (i) {
                ...
                if (!t(i.target).is("input, textarea")) {
                    var n = o.$document.find(e.CHIP + e.SELECTED_CHIP), a = n.closest(e.CHIPS),
                        r = n.siblings(e.CHIP).length, s = void 0;
                    if (n.length) {
                        var l = 8 === i.which || 46 === i.which, c = 37 === i.which, u = 39 === i.which;
                        if (l) {
                            i.preventDefault();
                            var d = a.data("index");
                ...
                var l = 8 === i.keyCode || 37 === i.keyCode, c = "" === n.val();
    ...
    var n, o, a = i("transform"), r = i("perspective"), s = navigator.userAgent,
        l = s.toLowerCase().indexOf("android") > -1, c = /iPad|iPhone|iPod/.test(s) && !t.MSStream,
    ...
    function v(e) {
        t.requestAnimationFrame(function () {
            "scroll" !== e.type && f();
            for (var t = 0,
                     i = p.length; t < i; t++)"scroll" !== e.type && (p[t].coverImage(), p[t].clipContainer()), p[t].onScroll()
        })
    }
    ...
    m.prototype.css = function (e, i) {
        ...
        if (this.image.width && this.image.height) {
            var t = this.image.$container.getBoundingClientRect(), e = t.width, i = t.height, n = t.left,
                a = this.image.width, r = this.image.height, s = this.options.speed,
                l = "scroll" === this.options.type || "scroll-opacity" === this.options.type, c = 0, u = 0, d = i,
                h = 0, f = 0;
        ...
        if (this.image.width && this.image.height) {
            var e = this.$item.getBoundingClientRect(), i = e.top, a = e.height,
                r = {visibility: "visible", backgroundPosition: "50% 50%"}, s = e;
            if (this.options.elementInViewport && (s = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = s.bottom >= 0 && s.right >= 0 && s.top <= o && s.left <= n, t || this.isElementInViewport) {
                var l = Math.max(0, i), c = Math.max(0, a + i), u = Math.max(0, -i), d = Math.max(0, i + a - o),
                    h = Math.max(0, a - (i + a - o)), f = Math.max(0, -i + o - a), p = 1 - 2 * (o - i) / (o + a), m = 1;
    ...
    var y = function (t) {
        ...
        for (var e, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = t.length,
                 a = 0; a < o; a++)if ("object" == typeof i || void 0 === i ? t[a].jarallax || (t[a].jarallax = new m(t[a], i)) : t[a].jarallax && (e = t[a].jarallax[i].apply(t[a].jarallax, n)), void 0 !== e)return e;
        return t
    };
    y.constructor = m;
    var b = t.jarallax;
    ...
    n.prototype.parseURL = function (t) {
        var e,
            i = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1],
            n = function (t) {
    ...
    n.prototype.loadAPI = function () {
        if (!o || !a) {
            ...
            if ("youtube" !== this.type || o || (o = 1, e = "//www.youtube.com/iframe_api"), "vimeo" !== this.type || a || (a = 1, e = "//player.vimeo.com/api/player.js"), e) {
                ...
                var i = document.createElement("script"), n = document.getElementsByTagName("head")[0];
                i.src = e, n.appendChild(i), n = null, i = null
            }
        }
    };
    var r = 0, s = 0, l = new e, c = new e;
