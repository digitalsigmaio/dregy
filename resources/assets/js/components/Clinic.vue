<template>
    ...
    <div class="container mt-5 pt-3">
        ...
        <div class="divider-new">
            <h3 class="h3-responsive font-weight-bold blue-text mx-3">Related Clinics</h3>
        </div>
    ...
    export default{
        ...
        methods: {
            ...
            rate() {
                if(this.user) {
                    let vm = this;
                    let rates = this.user.rate_for_clinics;
                    let id = this.clinic.id;
                    let rate;
                    ...
                    $('#example-fontawesome').barrating('show', {
                        ...
                        onSelect: function(value, text, event) {
                            if (typeof(event) !== 'undefined') {
                                ...
                                let endpoint = '/api/clinics/' + vm.clinic.id + '/users/' + vm.user.id + '/rate';
                                axios.post( endpoint, {
                                    user_id: vm.user.id,
                                    rate: value
                                })
